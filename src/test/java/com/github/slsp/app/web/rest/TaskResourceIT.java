...
import com.github.slsp.app.repository.TaskRepository;
import com.github.slsp.app.service.TaskService;
...
@WithMockUser
public class TaskResourceIT extends AbstractCassandraTest {
    ...
    public void getNonExistingTask() throws Exception {
        // Get the task
        restTaskMockMvc.perform(get("/api/tasks/{id}", UUID.randomUUID().toString()))
