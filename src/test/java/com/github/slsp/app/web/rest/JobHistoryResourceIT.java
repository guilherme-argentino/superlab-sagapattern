...
@WithMockUser
public class JobHistoryResourceIT extends AbstractCassandraTest {
    ...
    public void getAllJobHistories() throws Exception {
        ...
        restJobHistoryMockMvc.perform(get("/api/job-histories"))
    ...
    public void getNonExistingJobHistory() throws Exception {
        // Get the jobHistory
        restJobHistoryMockMvc.perform(get("/api/job-histories/{id}", UUID.randomUUID().toString()))
