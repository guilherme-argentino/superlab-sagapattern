...
@RestController
@RequestMapping("/api/super-lab-saga-pattern-kafka")
public class SuperLabSagaPatternKafkaResource {

    private final Logger log = LoggerFactory.getLogger(SuperLabSagaPatternKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SuperLabSagaPatternKafkaResource(KafkaProperties kafkaProperties) {
